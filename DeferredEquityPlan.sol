...
contract DeferredEquityPlan {
    ...
    uint fakenow = now; // For fastforward function
    ...
    function distribute() public {
        ...
        require((unlock_time <= now) && (distributed_shares < total_shares), "Minimum of 365 days required!! OR distributed shares cannot exceed total shares!!");
        ...
        distributed_shares = (now - start_time) * annual_distribution / 365;
